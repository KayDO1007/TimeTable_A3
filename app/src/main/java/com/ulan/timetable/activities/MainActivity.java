    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.facebookIcon:
                ...
                openUrlInChromeCustomTab(getApplicationContext(), fb);
                return true;
            case R.id.twitterIcon:
                String tw = "twitter.com";
                openUrlInChromeCustomTab(getApplicationContext(), tw);
                return true;
            case R.id.instagramIcon:
                String ig = "instagram.com";
                openUrlInChromeCustomTab(getApplicationContext(), ig);
                return true;
            case R.id.events:
